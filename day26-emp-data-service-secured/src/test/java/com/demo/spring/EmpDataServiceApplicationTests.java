...
class EmpDataServiceApplicationTests {
	...
	public void testFindOneEmp() throws Exception {
		...
		mvc.perform(get("/find/102")).andDo(print()).andExpect(status().isOk())
	...
	public void testSaveEmp() throws Exception {
		...
		Emp emp = new Emp(102, "Kailash", "Dehradoon", 89000.00);
    ...
    public void testUpdateSalary() throws Exception {
        ...
        when(empRepo.findById(102)).thenReturn(Optional.of(emp));
        when(empRepo.updateSalary(102,55000)).thenReturn(1);
        
        
        mvc.perform(patch("/updatesal/102/55000"))
        .andDo(print())
