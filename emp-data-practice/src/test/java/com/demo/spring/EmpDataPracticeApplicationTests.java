...
class EmpDataPracticeApplicationTests {
	...
	public void testfindOneEmp() throws Exception {
		when(empRepo.findById(110)).thenReturn(Optional.of(new Emp(110,"pratham", "goa",9000.0)));
	...
	public void testSaveEmp() throws Exception {
		Emp emp = new Emp(110,"pratham", "goa", 9000.0);
		ObjectMapper mapper = new ObjectMapper();
		String empJson=mapper.writeValueAsString(emp);

		when(empRepo.existsById(110)).thenReturn(false); 
